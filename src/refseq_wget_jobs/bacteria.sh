...
cd ../../data/refseq/bacteria

echo "Getting assembly summary"

wget ftp://ftp.ncbi.nlm.nih.gov/genomes/refseq/bacteria/assembly_summary.txt

awk -F '\t' '{if($12=="Complete Genome") print $20}' assembly_summary.txt > assembly_summary_complete_genomes_bacteria.txt

echo "Downloading genomes"

for next in $(cat assembly_summary_complete_genomes_bacteria.txt); do
