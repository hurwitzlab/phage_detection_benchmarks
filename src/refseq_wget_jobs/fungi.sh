...
cd ../../data/refseq/fungi

echo "Getting assembly summary"

wget ftp://ftp.ncbi.nlm.nih.gov/genomes/refseq/fungi/assembly_summary.txt

awk -F '\t' '{if($12=="Complete Genome") print $20}' assembly_summary.txt > assembly_summary_complete_genomes_fungi.txt

echo "Downloading genomes"

for next in $(cat assembly_summary_complete_genomes_fungi.txt); do
