...
out_dir="$out_path/metaphinder_out/"

# Tell metaphinder where to find BLAST
blast_loc='~/.conda/envs/metaphinder_env/bin'

# Run the tool
python $metaphinder_path -i $mock_community_path -o $out_dir -d $metaphinder_db_path -b $blast_loc
