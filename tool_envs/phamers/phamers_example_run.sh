...
source activate phamers_env

# Load any necessary modules
# module load my_modules

# Get current directory to help establish paths
DIR="/xdisk/bhurwitz/mig2020/rsgrps/bhurwitz/schackartk/projects/phage_finders/tool_envs/phamers"

cd $DIR

input_dir="../../src/genome_chopper/out"

python PhaMers/scripts/phamer.py -in $input_dir -data data --debug --equalize_reference
